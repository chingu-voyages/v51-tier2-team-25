        ...
        <div className="flex w-full gap-2">
          <div className='flex items-center w-1/3 mt-12 border rounded-md border-border bg-zinc-50'>
            <div className='flex flex-col justify-center w-full gap-1 px-3 py-6'>
              ...
              <p className='text-xl font-semibold text-gray-950'>$ {totalBalance.toFixed(2)}</p>
            </div> 
          </div>
          ...
          <div className='flex items-center w-1/3 mt-12 border rounded-md border-border bg-zinc-50'>
            <div className='flex flex-col justify-center w-full gap-1 px-3 py-6'>
              ...
              <p className='text-xl font-semibold text-green'>$ {totalToGet.toFixed(2)}</p>
            </div>            
          ...
          <div className='flex items-center w-1/3 mt-12 border rounded-md border-border bg-zinc-50'>
            <div className='flex flex-col justify-center w-full gap-1 px-3 py-6'>
              ...
              <p className='text-xl font-semibold text-red-700'>$ {totalOwe.toFixed(2)}</p>
            </div>            
